...
import { ref } from 'vue'
import { NetworkClient, defaultNetworkBase } from '@/api/networkClient'

export type SignupState = 'none' | 'pending' | 'active'

/** Network site self-registration, mirroring the network plugin's useSignupStore. */
export const useSignupStore = defineStore('signup', () => {
  const api = new NetworkClient(defaultNetworkBase())
