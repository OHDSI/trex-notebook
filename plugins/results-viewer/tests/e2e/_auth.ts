...
// results-viewer is loaded by the sibyl host shell, which gates plugins behind
// authentication. These helpers mirror sibyl/tests/e2e/_auth.ts so the e2e
// suite runs against a sibyl dev server without a live trex backend.
