var Ee = Object.defineProperty, o = (e, t) => Ee(e, "name", { value: t, configurable: !0 }), W = ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (t, r) => (typeof require < "u" ? require : t)[r] }) : e)(function(e) {
  ...
  return (r) => {
    for (var a = r.length, n = new Uint8Array((a - (r[a - 1] == "=") - (r[a - 2] == "=")) * 3 / 4 | 0), i = 0, s = 0; i < a; ) {
      var l = e[r.charCodeAt(i++)], c = e[r.charCodeAt(i++)], u = e[r.charCodeAt(i++)], f = e[r.charCodeAt(i++)];
      n[s++] = l << 2 | c >> 4, n[s++] = c << 4 | u >> 2, n[s++] = u << 6 | f;
    }
    return n;
  };
})();
...
o(R, "_getter");
var N = ["isConstructor", "isEval", "isNative", "isToplevel"], S = ["columnNumber", "lineNumber"], I = ["fileName", "functionName", "source"], Ne = ["args"], Se = ["evalOrigin"], F = N.concat(S, I, Ne, Se);
function m(e) {
...
for (w = 0; w < N.length; w++) m.prototype["get" + g(N[w])] = R(N[w]), m.prototype["set" + g(N[w])] = /* @__PURE__ */ (function(e) {
  return function(t) {
    this[e] = !!t;
  };
})(N[w]);
var w;
for (v = 0; v < S.length; v++) m.prototype["get" + g(S[v])] = R(S[v]), m.prototype["set" + g(S[v])] = /* @__PURE__ */ (function(e) {
  return function(t) {
    if (!M(t)) throw new TypeError(e + " must be a Number");
    this[e] = Number(t);
  };
})(S[v]);
var v;
for (E = 0; E < I.length; E++) m.prototype["get" + g(I[E])] = R(I[E]), m.prototype["set" + g(I[E])] = /* @__PURE__ */ (function(e) {
  return function(t) {
    this[e] = String(t);
  };
})(I[E]);
...
`).filter(function(n) {
    ...
    return a.map(function(n) {
      ...
      return new P({ functionName: c, fileName: u, lineNumber: l[1], columnNumber: l[2], source: n });
    }, this);
...
`).filter(function(n) {
    ...
    return a.map(function(n) {
      if (n.indexOf(" > eval") > -1 && (n = n.replace(/ line (\d+)(?: > eval line \d+)* > eval:\d+:\d+/g, ":$1")), n.indexOf("@") === -1 && n.indexOf(":") === -1) return new P({ functionName: n });
      var i = /((.*".+"[^@]*)?[^@]*)(?:@)/, s = n.match(i), l = s && s[1] ? s[1] : void 0, c = this.extractLocation(n.replace(i, ""));
      return new P({ functionName: l, fileName: c[0], lineNumber: c[1], columnNumber: c[2], source: n });
    }, this);
...
function B() {
  ...
  return j({ IN_BUN: e, IN_DENO: t, IN_NODE: r, IN_SAFARI: a, IN_SHELL: typeof read == "function" && typeof load == "function" });
}
o(B, "getGlobalRuntimeEnv");
var d = B();
function j(e) {
  let t = e.IN_NODE && typeof module < "u" && module.exports && typeof W == "function" && typeof __dirname == "string", r = e.IN_NODE && !t, a = !e.IN_NODE && !e.IN_DENO && !e.IN_BUN, n = a && typeof window < "u" && typeof window.document < "u" && typeof document.createElement == "function" && "sessionStorage" in window && typeof globalThis.importScripts != "function", i = a && typeof globalThis.WorkerGlobalScope < "u" && typeof globalThis.self < "u" && globalThis.self instanceof globalThis.WorkerGlobalScope;
  return { ...e, IN_BROWSER: a, IN_BROWSER_MAIN_THREAD: n, IN_BROWSER_WEB_WORKER: i, IN_NODE_COMMONJS: t, IN_NODE_ESM: r };
}
o(j, "calculateDerivedFlags");
var H, D, z, C, x;
async function T() {
  if (!d.IN_NODE || (H = (await import("./__vite-browser-external-CPvbk0mb.js")).default, C = await import("./__vite-browser-external-CPvbk0mb.js"), x = await import("./__vite-browser-external-CPvbk0mb.js"), z = (await import("./__vite-browser-external-CPvbk0mb.js")).default, D = await import("./__vite-browser-external-CPvbk0mb.js"), U = D.sep, typeof W < "u")) return;
  let e = C, t = await import("./__vite-browser-external-CPvbk0mb.js"), r = await import("./__vite-browser-external-CPvbk0mb.js"), a = await import("./__vite-browser-external-CPvbk0mb.js"), n = { fs: e, crypto: t, ws: r, child_process: a };
...
o(V, "node_resolvePath");
function q(e, t) {
  return t === void 0 && (t = location), new URL(e, t).toString();
}
o(q, "browser_resolvePath");
var _;
d.IN_NODE ? _ = V : d.IN_SHELL ? _ = o((e) => e, "resolvePath") : _ = q;
var U;
d.IN_NODE || (U = "/");
function G(e, t) {
  return e.startsWith("file://") && (e = e.slice(7)), e.includes("://") ? { response: fetch(e) } : { binary: x.readFile(e).then((r) => new Uint8Array(r.buffer, r.byteOffset, r.byteLength)) };
}
o(G, "node_getBinaryResponse");
function J(e, t) {
...
o(J, "shell_getBinaryResponse");
function K(e, t) {
  let r = new URL(e, location);
  return { response: fetch(r, t ? { integrity: t } : {}) };
}
o(K, "browser_getBinaryResponse");
var k;
d.IN_NODE ? k = G : d.IN_SHELL ? k = J : k = K;
...
o(Y, "loadBinaryFile");
var A;
if (d.IN_BROWSER_MAIN_THREAD) A = o(async (e) => await import(e), "loadScript");
else if (d.IN_BROWSER_WEB_WORKER) A = o(async (e) => {
  try {
...
else if (d.IN_NODE) A = Z;
else if (d.IN_SHELL) A = load;
else throw new Error("Cannot determine runtime environment");
async function Z(e) {
  e.startsWith("file://") && (e = e.slice(7)), e.includes("://") ? z.runInThisContext(await (await fetch(e)).text()) : await import(H.pathToFileURL(e).href);
}
o(Z, "nodeLoadScript");
async function Q(e) {
  if (d.IN_NODE) {
    await T();
    let t = await x.readFile(e, { encoding: "utf8" });
    return JSON.parse(t);
  } else if (d.IN_SHELL) {
    let t = read(e);
    return JSON.parse(t);
...
o(Q, "loadLockFile");
async function X() {
  if (d.IN_NODE_COMMONJS) return __dirname;
  let e;
  try {
    throw new Error();
  } catch (a) {
  ...
  let t = Ae.parse(e)[0].fileName;
  if (d.IN_NODE && !t.startsWith("file://") && (t = `file://${t}`), d.IN_NODE_ESM) {
...
function te(e) {
  let t = e.FS, r = e.FS.filesystems.MEMFS, a = e.PATH, n = { DIR_MODE: 16895, FILE_MODE: 33279, mount: o(function(i) {
    ...
    try {
      let c = n.getLocalSet(i), u = await n.getRemoteSet(i), f = s ? u : c, y = s ? c : u;
      await n.reconcile(i, f, y), l(null);
    } catch (c) {
      l(c);
    }
    ...
    o(l, "isRealDir");
    function c(f) {
      return (y) => a.join2(f, y);
    }
    o(c, "toAbsolute");
    let u = t.readdir(i.mountpoint).filter(l).map(c(i.mountpoint));
    for (; u.length; ) {
      let f = u.pop(), y = t.stat(f);
      t.isDir(y.mode) && u.push.apply(u, t.readdir(f).filter(l).map(c(f))), s[f] = { timestamp: y.mtime, mode: y.mode };
    }
    return { type: "local", entries: s };
  }, "getLocalSet"), getRemoteSet: o(async (i) => {
    let s = /* @__PURE__ */ Object.create(null), l = await Oe(i.opts.fileSystemHandle);
    ...
    if (u.kind === "file") {
      let f = await u.createWritable();
      await f.write(l.contents), await f.close();
    }
    i.set(s, u);
    ...
    if (Object.keys(l.entries).forEach(function(p) {
      s.entries[p] || (f.push(p), c++);
    }), f.sort().reverse(), !c) return;
    let y = s.type === "remote" ? s.handles : l.handles;
    for (let p of u) {
      let h = a.normalize(p.replace(i.mountpoint, "/")).substring(1);
      if (l.type === "local") {
        let b = y.get(h), ve = await n.loadRemoteEntry(b);
        n.storeLocalEntry(p, ve);
      } else {
        let b = n.loadLocalEntry(p);
        await n.storeRemoteEntry(y, h, b);
      }
    }
    for (let p of f) if (l.type === "local") n.removeLocalEntry(p);
    else {
      let h = a.normalize(p.replace(i.mountpoint, "/")).substring(1);
...
var Oe = o(async (e) => {
  ...
  return a;
}, "getFsHandles"), _e = be("AGFzbQEAAAABDANfAGAAAW9gAW8BfwMDAgECByECD2NyZWF0ZV9zZW50aW5lbAAAC2lzX3NlbnRpbmVsAAEKEwIHAPsBAPsbCwkAIAD7GvsUAAs="), ke = (async function() {
  if (!(globalThis.navigator && (/iPad|iPhone|iPod/.test(navigator.userAgent) || navigator.platform === "MacIntel" && typeof navigator.maxTouchPoints < "u" && navigator.maxTouchPoints > 1))) try {
    let e = await WebAssembly.compile(_e);
...
o(re, "getSentinelImport");
function ne(e) {
  let t = { config: e, runtimeEnv: d }, r = { noImageDecoding: !0, noAudioDecoding: !0, noWasmDecoding: !1, preRun: ce(e), print: e.stdout, printErr: e.stderr, onExit(a) {
    r.exitCode = a;
  }, thisProgram: e._sysExecutable, arguments: e.args, API: t, locateFile: o((a) => e.indexURL + a, "locateFile"), instantiateWasm: ue(e.indexURL) };
  return r;
}
o(ne, "createSettings");
function ie(e) {
...
function ce(e) {
  let t;
  return e.stdLibURL != null ? t = e.stdLibURL : t = e.indexURL + "python_stdlib.zip", [le(t), ie(e.env.HOME), ae(e.env), te, ...oe(e.fsInit)];
}
o(ce, "getFileSystemInitializationFuncs");
function ue(e) {
  if (typeof WasmOffsetConverter < "u") return;
  let { binary: t, response: r } = k(e + "pyodide.asm.wasm"), a = re();
  return function(n, i) {
...
o(ue, "getInstantiateWasmFunc");
var Fe = "0.29.0";
function O(e) {
  return e === void 0 || e.endsWith("/") ? e : e + "/";
}
o(O, "withTrailingSlash");
var L = Fe;
async function fe(e = {}) {
  ...
  if (t = O(_(t)), e.packageBaseUrl = O(e.packageBaseUrl), e.cdnUrl = O(e.packageBaseUrl ?? `https://cdn.jsdelivr.net/pyodide/v${L}/full/`), !e.lockFileContents) {
    let n = e.lockFileURL ?? t + "pyodide-lock.json";
    e.lockFileContents = Q(n), e.packageBaseUrl ??= ee(n);
  }
...
o(me, "prepareSnapshot");
async function ye(e) {
  let t = await _createPyodideModule(e);
  if (e.exitCode !== void 0) throw new t.ExitStatus(e.exitCode);
  return t;
}
o(ye, "createPyodideModule");
function ge(e, t) {
  let r = e.API;
  if (t.pyproxyToStringRepr && r.setPyProxyToStringMethod(!0), t.convertNullToNone && r.setCompatNullToNone(!0), t.toJsLiteralMap && r.setCompatToJsLiteralMap(!0), r.version !== L && t.checkAPIVersion) throw new Error(`Pyodide version does not match: '${L}' <==> '${r.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`);
  e.locateFile = (a) => {
...
o(we, "finalizeSetup");
async function Re(e = {}) {
  let t = await fe(e), r = de(t);
  await pe(t);
  let a = await me(t, r), n = await ye(r);
  ge(n, t);
  let i = he(n, a, t);
  return await we(i, t);
}
